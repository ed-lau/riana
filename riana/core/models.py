...
Lifted unchanged from ``riana.models`` in the M3 (1.0.0) restructure. The
``plot_model`` ``model_to_use=`` keyword fix already landed in 0.9.0, so this is
a verbatim move. See PROJECT_REVIEW.md §3.
"""
