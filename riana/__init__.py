...
# line (adaptive N_ISO, H4′ FS solve, --fs limited-isotopomer scoring + its
# init-width-keyed widening and GUI exposure). 1.1.0 is the active dev line: the
# experimental science (o18 rewrite, Δmass-over-time GUI + mass-defect→θ fitting).
