...
setup(
   ...
   data_files=[('tests',
                 [os.path.join('tests', 'data', 'sample1', 'percolator.target.mzid'),
                  ...
                  os.path.join('tests', 'data', 'sample1', 'mhcc_d01_A10.mzML.gz'),
                  os.path.join('tests', 'data', 'sample2', 'percolator.target.mzid'),
                  os.path.join('tests', 'data', 'sample2', 'percolator.target.psms.txt'),
                  os.path.join('tests', 'data', 'sample2', 'mhcc_d01_A12.mzML.gz'),
                  os.path.join('tests', 'data', 'sample3', 'percolator.target.mzid'),
                  os.path.join('tests', 'data', 'sample3', 'percolator.target.psms.txt'),
                  os.path.join('tests', 'data', 'sample3', 'mhcc_d01_A14.mzML.gz'),
                  ]),
                ],
