...
_BSA_MZTAB = (
    ...
    # exp_mass_to_charge 480.6112 is the BSA mzML's real precursor m/z at scan 4408,
    # so the intake scan↔precursor guard (DataError on a mass mismatch) passes.
    "PSM\tRHPEYAVSVLLR\t0\tsp|P02769|ALBU_BOVIN\t1\tdb\tnull\t[, , dummy, 1]\t"
    "0.001\tnull\t541.1\t3\t480.6112\t480.6112\t"
